...
const PollPage = ({ dispatch, authedUser, question, author }) => {
  ...
  return (
    <div>
      <h2 className="flex justify-center text-3xl font-bold mt-9 mb-5">Poll by {author.id}</h2>
      ...
      <div className="grid grid-cols-2 gap-4 mt-4">
        <button
          ...
          disabled={hasVoted}
          className={
            "p-2 rounded bg-zinc-100 hover:shadow-xl transition " +
            (hasVotedForOptionOne ? "bg-sky-300" : "bg-zinc-100")
          }
        >
        ...
        <button
          ...
          disabled={hasVoted}
          className={
            "p-2 rounded hover:shadow-xl transition " +
            (hasVotedForOptionTwo ? "bg-sky-300" : "bg-zinc-100")
          }
        >
